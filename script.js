...
const verificarUser = (item) =>{
    if(item.userImageURL == ''){
        item.userImageURL = 'img/usuario.png'
...
const criarItem = item =>{
    ...
    newCard.innerHTML = `
                ...
                <div class="options">
                    ...
                    <div class="row">
                        <div class="row info"><img src="img/curtir.png">${item.likes}</div>
                        <div class="row info"><img src="img/comentar.png">${item.comments}</div>
                        <div class="row info"><img src="img/favoritar.png"></div>
                    </div>
                </div>
